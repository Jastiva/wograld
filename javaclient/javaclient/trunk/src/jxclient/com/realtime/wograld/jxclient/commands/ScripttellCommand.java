...
public class ScripttellCommand extends AbstractCommand {
     ...
     */
    public ScripttellCommand(@NotNull final ScriptManager scriptManager, @NotNull final WograldServerConnection wograldServerConnection) {
        super("scripttell", wograldServerConnection);
