...
/**
 * A {@link ValidationError} that reports I/O errors related to {@link
...
public class MapCheckerScriptIOError<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> extends ValidationError<G, A, R> {
     ...
     * @param file the file name related to the error message
     * @param message the error message
     */
    public MapCheckerScriptIOError(@NotNull final MapModel<G, A, R> mapModel, @NotNull final String file, @NotNull final String message) {
        super(mapModel);
        this.file = file;
