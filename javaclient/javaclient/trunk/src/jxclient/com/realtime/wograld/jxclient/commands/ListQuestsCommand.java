...
public class ListQuestsCommand extends AbstractCommand {
     ...
     */
    public ListQuestsCommand(@NotNull final WograldServerConnection wograldServerConnection, @NotNull final CommandCallback commandCallback, @NotNull final GUICommandFactory guiCommandFactory, @NotNull final CommandQueue commandQueue) {
        super("questlist", wograldServerConnection);
    ...
    public void execute(@NotNull final String args) {
       this.commandQueue.sendNcom(false, "listquests");
    }
