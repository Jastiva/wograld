...
import com.realtime.wograld.jxclient.gui.log.GUILog;
...
public class JXCWindowRenderer {
     ...
     * <code>null</code>
     */
    public JXCWindowRenderer(@NotNull final MouseTracker mouseTracker, @NotNull final WograldServerConnection wograldServerConnection, @Nullable final Writer debugScreen) {
    ...
    public void updateServerSettings() {
        ...
        wograldServerConnection.setPreferredMapSize(mapSize.width, mapSize.height);
        wograldServerConnection.setPreferredNumLookObjects(getNumLookObjects());
    }
