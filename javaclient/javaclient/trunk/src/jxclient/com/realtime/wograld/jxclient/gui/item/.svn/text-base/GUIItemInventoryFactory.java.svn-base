...
public class GUIItemInventoryFactory implements GUIItemItemFactory {
    ...
    /**
     * The {@link WograldServerConnection connection} instance.
     */
    @NotNull
     ...
     */
    public GUIItemInventoryFactory(@NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final CommandQueue commandQueue, @NotNull final String name, @NotNull final ItemPainter itemPainter, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final FacesManager facesManager, @NotNull final FloorView floorView, @NotNull final ItemView inventoryView) {
    ...
    public GUIElement newItem(final int index) {
        return new GUIItemInventory(tooltipManager, elementListener, commandQueue, name+index, itemPainter, index, wograldServerConnection, facesManager, floorView, inventoryView);
    }
    ...
    public GUIItemItem newTemplateItem(final int cellHeight) {
        final GUIItemItem result = new GUIItemInventory(tooltipManager, elementListener, commandQueue, name+"_template", itemPainter, -1, wograldServerConnection, facesManager, floorView, inventoryView);
