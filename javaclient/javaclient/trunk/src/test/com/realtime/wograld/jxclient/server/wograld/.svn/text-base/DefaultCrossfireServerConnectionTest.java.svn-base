...
/**
 * Regression tests for {@link DefaultWograldServerConnection}.
 * @author Andreas Kirschbaum
 */
public class DefaultWograldServerConnectionTest {
    ...
    /**
     * Checks that {@link DefaultWograldServerConnection#setPreferredNumLookObjects(int)}
    ...
    public void testNegotiateNumLookObjects1() throws InterruptedException, IOException {
        sem = new Semaphore(0);
        final DefaultWograldServerConnection connection = new DefaultWograldServerConnection(null, "version");
    ...
    /**
     * Starts a dummy Wograld server.
     * @return the port the Wograld server is listening on
    ...
    private int startServer() throws IOException {
        ...
        final Thread thread = new Thread(new Runnable() {
            ...
            /**
             * Reads a Wograld message from an {@link InputStream}.
            ...
            /**
             * Write a Wograld message to the client.
