...
public abstract class AbstractFacesManager implements FacesManager {
    ...
    public ImageIcon getSpellImageIcon(final int faceNum, @Nullable final boolean[] isUnknownImage){
        return getSpellFaceImages(faceNum,isUnknownImage).getOriginalImageIcon();
    }
 ...
 //   @NotNull
  ...
  //  }
    ...
    protected abstract FaceImages getSpellFaceImages(final int faceNum, @Nullable boolean[] isUnknownImage);
    ...
    public Face lookupSpellFace(final int faceNum){
        return faceCache.getSpellFace(faceNum);
    }
    ...
    public ImageIcon getBlockedImageIcon(){
        return getBlockedImages().getOriginalImageIcon();
    }
    
    public ImageIcon getDark1ImageIcon(){
        return getDark1Images().getOriginalImageIcon();
    }
    
    public ImageIcon getDark2ImageIcon(){
        return getDark2Images().getOriginalImageIcon();
    }
    
    public ImageIcon getDark3ImageIcon(){
        return getDark3Images().getOriginalImageIcon();
    }
    
    public ImageIcon getFogofwarImageIcon(){
        return getFogofwarImages().getOriginalImageIcon();
    }
    
    protected abstract FaceImages getBlockedImages();
    protected abstract FaceImages getDark1Images();
    protected abstract FaceImages getDark2Images();
    protected abstract FaceImages getDark3Images();
    protected abstract FaceImages getFogofwarImages();
