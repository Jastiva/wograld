...
package com.realtime.wograld.jxclient.window;

import com.realtime.wograld.jxclient.gui.commands.CommandList;
import com.realtime.wograld.jxclient.gui.commands.NoSuchCommandException;
...
public class GuiManager {
    ...
    /**
     * The {@link WograldServerConnection} instance to monitor.
     */
    @NotNull
    private final WograldServerConnection server;

    /**
     * The {@link WograldDrawextinfoListener} attached to {@link #server}.
     */
    @NotNull
    ...
    private final GuiStateListener guiStateListener = new GuiStateListener() {
        ...
        public void start() {
            ...
            server.removeWograldDrawextinfoListener(wograldDrawextinfoListener);
            server.removeWograldFailureListener(wograldFailureListener);
        ...
        public void connecting(@NotNull final String serverInfo) {
            ...
            server.addWograldDrawextinfoListener(wograldDrawextinfoListener);
            server.addWograldFailureListener(wograldFailureListener);
     ...
     * @param server the wograld server connection to monitor
     ...
     */
    public GuiManager(@NotNull final GuiStateManager guiStateManager, @NotNull final TooltipManager tooltipManager, @NotNull final Settings settings, @NotNull final WograldServerConnection server, @NotNull final JXCWindowRenderer windowRenderer, @NotNull final GuiFactory guiFactory, @NotNull final KeybindingsManager keybindingsManager, @NotNull final JXCConnection connection) {
    ...
    public void openQueryDialog(@NotNull final String prompt, final int queryType) {
        ...
        queryDialog.setHideInput((queryType&WograldQueryListener.HIDE_INPUT) != 0);
    ...
    private void activateMetaserverGui() {
        final String serverName = settings.getString("server", "wograld.metalforge.net");
    ...
    private void updateConnectLabel(@NotNull final ClientSocketState clientSocketState, @Nullable final String param) {
        if (dialogConnectLabel != null) {
            ...
            case CONNECT_FAILED:
                message = "Cannot connect to Wograld server:\n"+param;
                break;
            }
