...
package com.realtime.wograld.jxclient.server.socket;
...
public interface ClientSocketListener extends EventListener {
    ...
    /**
     * Called when connecting to a Wograld server.
     */
    void connecting();

    /**
     * Called after a connection to a Wograld server has been established.
     */
    void connected();

    /**
     * Called whenever a packet is received from the Wograld server.
    ...
    /**
     * Called whenever a packet has been sent to the Wograld server.
