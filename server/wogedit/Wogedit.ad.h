...
"*email:		gnu@foo.bar",
"*cmdWograld:	wograld -pix",
"*cmdReset:	crossclient -cmd 'dm dm;reset %s'",
"*cmdGoto:	crossclient -cmd 'dm dm;goto %s'",
"Wogedit*font: -*-helvetica-bold-r-*-*-12-*-*-*-*-*-*-*",
"Wogedit*Text*font: *-lucidatypewriter-medium-r-normal-*-12-*-*-*-*-*-*-*",
"*title:			CrossEdit",
"*iconName:		CrossEdit",
"*new.label:		New",
"*open.label:		Open",
"*wograld.label:	CrossFire",
"*quit.label:		Quit",
...
"*vars.label:		Variable",
"*exact.label:		Dump",
"Wogedit*background:		DarkSeaGreen",
"Wogedit*foreground:		Black",
"Wogedit*SimpleMenu*background:ForestGreen",
"Wogedit*SimpleMenu*foreground:White",
"Wogedit*Command*background:	ForestGreen",
"Wogedit*Command*foreground:	White",
"Wogedit*Toggle*background:	ForestGreen",
"Wogedit*Toggle*foreground:	White",
"Wogedit*MenuButton*background:ForestGreen",
"Wogedit*MenuButton*foreground:White",
"Wogedit*Label*background:	ForestGreen",
"Wogedit*Label*foreground:	White",
"Wogedit*CrEdit*background:	gray60",
"Wogedit*CrList*background:	DarkSeaGreen",
"Wogedit*CrFace*background:	DarkSeaGreen",
"*box.min: 28",
"*box.max: 28",
