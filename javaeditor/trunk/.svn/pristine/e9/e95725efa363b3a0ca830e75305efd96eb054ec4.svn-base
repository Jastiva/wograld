...
/**
 * An {@link ArchetypeAttribute} for selecting an optional spell encoded as an
 * integer attribute.
 * @author <a href="mailto:andi.vogl@gmx.net">Andreas Vogl</a>
 * @author Andreas Kirschbaum
 */
public class ArchetypeAttributeZSpell extends AbstractArchetypeAttributeSpell {
     ...
     */
    public ArchetypeAttributeZSpell(@NotNull final String archetypeAttributeName, @NotNull final String attributeName, @NotNull final String description, final int inputLength, @NotNull final String sectionName) {
