...
/**
 * Helper class to synthesize an "active skill" stat value. The Wograld server
...
public class ActiveSkillWatcher {
     ...
     */
    public ActiveSkillWatcher(@NotNull final Stats stats, @NotNull final WograldServerConnection wograldServerConnection) {
        this.stats = stats;
    ...
    private void setActive(@NotNull final String activeSkill) {
        // Normalize skill name: the Wograld server sometimes sends "Skill:
