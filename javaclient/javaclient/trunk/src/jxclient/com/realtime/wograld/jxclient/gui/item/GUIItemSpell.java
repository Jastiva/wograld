...
import com.realtime.wograld.jxclient.gui.Modifiers;
...
import com.realtime.wograld.jxclient.spells.SpellListener;
import com.realtime.wograld.jxclient.spells.SpellsManager;
import com.realtime.wograld.jxclient.spells.SpellsManagerListener;
...
public class GUIItemSpell extends GUIItemItem {
    ...
    public GUIItemSpell(@NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final CommandQueue commandQueue, @NotNull final String name, @NotNull final ItemPainter itemPainter, final int defaultIndex, @NotNull final FacesManager facesManager, @NotNull final SpellsManager spellsManager, @NotNull final CurrentSpellManager currentSpellManager, @NotNull final ItemView spellsView) {
        ...
        this.spellsManager.addWograldSpellChangedListener(spellsManagerListener);
    ...
    public void dispose() {
        super.dispose();
        spellsManager.removeWograldSpellChangedListener(spellsManagerListener);
    ...
    protected Image getFace(@NotNull final CfItem item) {
       if(item.getFace() != null){
        return facesManager.getSpellImageIcon(item.getFace().getFaceNum(), null).getImage();
       }
      // else return null;
      //  else return facesManager.getFaceImages(0,null).getImage();
       else return facesManager.getOriginalImageIcon(0,null).getImage();
