...
extern void Image3Cmd(uint8 *data, int len);
extern void display_newpng(long face, uint8 *buf, long buflen, int setnum);
extern void display_newpng2(long face, uint8 *buf, long buflen, int setnum);
...
extern void FcnmCmd(unsigned char *data, int len);
extern void Up1Cmd(unsigned char *data, int len);
extern void Up2Cmd(unsigned char *data, int len);
extern void Up3Cmd(unsigned char *data, int len);
extern void Low1Cmd(unsigned char *data, int len);
extern void Low2Cmd(unsigned char *data, int len);
extern void Low3Cmd(unsigned char *data, int len);
extern void EnableFloorCmd(unsigned char *data, int len);
extern void DisableFloorCmd(unsigned char *data, int len);
