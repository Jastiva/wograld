...
public class GUIItemFloorFactory implements GUIItemItemFactory {
     ...
     * @param wograldServerConnection the wograld server connection to use
     ...
     */
    public GUIItemFloorFactory(@NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final CommandQueue commandQueue, @NotNull final String name, @NotNull final ItemPainter itemPainter, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final FacesManager facesManager, @NotNull final FloorView floorView, @NotNull final ItemSet itemSet, @NotNull final Image nextGroupFace, @NotNull final Image prevGroupFace) {
    ...
    public GUIElement newItem(final int index) {
        return new GUIItemFloor(tooltipManager, elementListener, commandQueue, name+index, itemPainter, index, wograldServerConnection, floorView, itemSet, facesManager, nextGroupFace, prevGroupFace);
    }
    ...
    public GUIItemItem newTemplateItem(final int cellHeight) {
        final GUIItemItem result = new GUIItemFloor(tooltipManager, elementListener, commandQueue, name+"_template", itemPainter, -1, wograldServerConnection, floorView, itemSet, facesManager, nextGroupFace, prevGroupFace);
