...
package com.realtime.wograld.jxclient.util;
...
public class ResourceUtils {
    ...
    public static final String BLOCKED_PNG = "blocked.png";
    
    public static final String DARK1_PNG = "dark1.png";
    
    public static final String DARK2_PNG = "dark2.png";
    
    public static final String DARK3_PNG = "dark3.png";
    
    public static final String FOGOFWAR_PNG = "fogofwar.png";
