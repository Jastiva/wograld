 ...
 */
public interface WograldUpdateMapListener extends EventListener {
     ...
     */
    void mapClear(int x, int y, int floor);
     ...
     */
    void mapDarkness(int x, int y, int darkness, int floor);
    ...
    void eraseFloor(int upfloor);
    
    void carveViewpoint(int x, int y, int maxfloor);
