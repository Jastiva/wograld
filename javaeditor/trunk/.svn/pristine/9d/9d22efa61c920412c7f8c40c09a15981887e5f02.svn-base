...
/**
 * An {@link ArchetypeAttribute} for selecting face names.
...
public class ArchetypeAttributeFaceName extends ArchetypeAttribute {
     ...
     */
    public ArchetypeAttributeFaceName(@NotNull final String archetypeAttributeName, @NotNull final String attributeName, @NotNull final String description, final int inputLength, @NotNull final String sectionName) {
