...
public class FaceImages {
    ...
    /**
     * The {@link ImageIcon} as sent by the Wograld server.
     */
    @NotNull
  ...
  //  private final ImageIcon scaledImageIcon;
     ...
     * @param originalImageIcon the image icon as sent by the Wograld server
  ...
  //  public FaceImages(@NotNull final ImageIcon originalImageIcon, @NotNull final ImageIcon scaledImageIcon, @NotNull final ImageIcon magicMapImageIcon) {
    public FaceImages(@NotNull final ImageIcon originalImageIcon, @NotNull final ImageIcon magicMapImageIcon) {
    ...
    /**
     * Returns the {@link ImageIcon} as sent by the Wograld server.
