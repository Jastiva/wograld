...
public class GuiManagerCommandCallback implements CommandCallback {
    ...
    /**
     * The {@link WograldServerConnection} for sending commands.
     */
    @NotNull
     ...
     * @param server the wograld server connection for sending commands
     */
    public GuiManagerCommandCallback(@NotNull final Exiter exiter, @NotNull final WograldServerConnection server) {
        this.exiter = exiter;
        this.server = server;
    }
