...
import com.realtime.wograld.jxclient.shortcuts.Shortcut;
import com.realtime.wograld.jxclient.shortcuts.ShortcutCommand;
import com.realtime.wograld.jxclient.shortcuts.ShortcutListener;
import com.realtime.wograld.jxclient.shortcuts.ShortcutSpell;
import com.realtime.wograld.jxclient.shortcuts.ShortcutVisitor;
import com.realtime.wograld.jxclient.shortcuts.Shortcuts;
import com.realtime.wograld.jxclient.shortcuts.ShortcutsListener;
    ...
    public void paintComponent(@NotNull final Graphics g) {
        ...
        final ShortcutVisitor visitor = new ShortcutVisitor() {
            ...
            public void visit(@NotNull final ShortcutSpell shortcutSpell) {
                ...
                g.drawImage(facesManager.getSpellImageIcon(shortcutSpell.getSpell().getFaceNum(), null).getImage(), 0, 0, null);
                // original
