...
public class Options {
    ...
    /**
     * The Wograld server to connect to or <code>null</code> to show the
    ...
    /**
     * The filename for Wograld protocol message logs or <code>null</code> to
    ...
    public void parse(@NotNull final String[] args) {
        ...
        if (skin.equals("com.realtime.wograld.jxclient.JXCSkinPrelude")) {
            skin = "default";
        }
    ...
    /**
     * Returns the filename for Wograld protocol debug logs.
     * @return the filename or <code>null</code> to not log Wograld protocol
     *         messages
     */
    @Nullable
    ...
    /**
     * Returns the Wograld server to connect to.
