...
import com.realtime.wograld.jxclient.map.Location;
...
import com.realtime.wograld.jxclient.server.server.DefaultServerConnection;
...
import com.realtime.wograld.jxclient.server.socket.UnknownCommandException;
import com.realtime.wograld.jxclient.util.DebugWriter;
import com.realtime.wograld.jxclient.util.EventListenerList2;
import com.realtime.wograld.jxclient.util.HexCodec;
...
/**
 * Default implementation of {@link WograldServerConnection}.
 * @author Andreas Kirschbaum
 */
public class DefaultWograldServerConnection extends DefaultServerConnection implements WograldServerConnection {
    ...
    /**
     * The {@link WograldServerConnectionListener WograldServerConnectionListeners}
     * to notify.
     */
    @NotNull
    private final EventListenerList2<WograldServerConnectionListener> wograldServerConnectionListeners = new EventListenerList2<WograldServerConnectionListener>(WograldServerConnectionListener.class);

    /**
     * The {@link WograldDrawinfoListener WograldDrawinfoListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldDrawinfoListener> drawinfoListeners = new EventListenerList2<WograldDrawinfoListener>(WograldDrawinfoListener.class);

    /**
     * The {@link WograldDrawextinfoListener WograldDrawextinfoListeners} to
     * be notified.
     */
    @NotNull
    private final EventListenerList2<WograldDrawextinfoListener> drawextinfoListeners = new EventListenerList2<WograldDrawextinfoListener>(WograldDrawextinfoListener.class);

    /**
     * The {@link WograldQueryListener WograldQueryListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldQueryListener> queryListeners = new EventListenerList2<WograldQueryListener>(WograldQueryListener.class);

    /**
     * The {@link WograldMagicmapListener WograldMagicmapListeners} to be
     * notified of received magicmap commands.
     */
    @NotNull
    private final EventListenerList2<WograldMagicmapListener> magicmapListeners = new EventListenerList2<WograldMagicmapListener>(WograldMagicmapListener.class);

    /**
     * The {@link WograldUpdateFaceListener WograldUpdateFaceListeners} to
     * be notified.
     */
    @NotNull
    private final EventListenerList2<WograldUpdateFaceListener> wograldUpdateFaceListeners = new EventListenerList2<WograldUpdateFaceListener>(WograldUpdateFaceListener.class);

    /**
     * The {@link WograldStatsListener WograldStatsListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldStatsListener> wograldStatsListeners = new EventListenerList2<WograldStatsListener>(WograldStatsListener.class);

    /**
     * The {@link WograldUpdateItemListener WograldUpdateItemListeners} to
     * be notified.
     */
    @NotNull
    private final EventListenerList2<WograldUpdateItemListener> wograldUpdateItemListeners = new EventListenerList2<WograldUpdateItemListener>(WograldUpdateItemListener.class);

    /**
     * The {@link WograldUpdateMapListener} to be notified. Set to
     * <code>null</code> if unset.
     */
    @Nullable
    private WograldUpdateMapListener wograldUpdateMapListener;

    /**
     * The {@link WograldTickListener WograldTickListeners} to be notified.
     */
    @NotNull
    private final EventListenerList2<WograldTickListener> wograldTickListeners = new EventListenerList2<WograldTickListener>(WograldTickListener.class);

    /**
     * The {@link WograldSoundListener WograldSoundListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldSoundListener> wograldSoundListeners = new EventListenerList2<WograldSoundListener>(WograldSoundListener.class);

    /**
     * The {@link WograldSmoothListener WograldSmoothListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldSmoothListener> wograldSmoothListeners = new EventListenerList2<WograldSmoothListener>(WograldSmoothListener.class);

    /**
     * The {@link WograldMusicListener WograldMusicListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldMusicListener> wograldMusicListeners = new EventListenerList2<WograldMusicListener>(WograldMusicListener.class);

    /**
     * The {@link WograldComcListener WograldComcListeners} to be notified.
     */
    @NotNull
    private final EventListenerList2<WograldComcListener> wograldComcListeners = new EventListenerList2<WograldComcListener>(WograldComcListener.class);

    /**
     * The {@link WograldFaceListener WograldFaceListeners} to be notified.
     */
    @NotNull
    private final EventListenerList2<WograldFaceListener> wograldFaceListeners = new EventListenerList2<WograldFaceListener>(WograldFaceListener.class);

    /**
     * The {@link WograldSpellListener WograldSpellListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldSpellListener> wograldSpellListeners = new EventListenerList2<WograldSpellListener>(WograldSpellListener.class);

    /**
     * The {@link WograldQuestListener WograldQuestListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldQuestListener> wograldQuestListeners = new EventListenerList2<WograldQuestListener>(WograldQuestListener.class);
    ...
    /**
     * The {@link WograldExpTableListener WograldExpTableListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldExpTableListener> wograldExpTableListeners = new EventListenerList2<WograldExpTableListener>(WograldExpTableListener.class);

    /**
     * The {@link WograldSkillInfoListener WograldSkillInfoListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldSkillInfoListener> wograldSkillInfoListeners = new EventListenerList2<WograldSkillInfoListener>(WograldSkillInfoListener.class);

    /**
     * The {@link WograldPickupListener WograldPickupListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldPickupListener> wograldPickupListeners = new EventListenerList2<WograldPickupListener>(WograldPickupListener.class);

    /**
     * The {@link WograldAccountListener WograldAccountListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldAccountListener> wograldAccountListeners = new EventListenerList2<WograldAccountListener>(WograldAccountListener.class);

    /**
     * The {@link WograldFailureListener WograldFailureListeners} to be
     * notified.
     */
    @NotNull
    private final EventListenerList2<WograldFailureListener> wograldFailureListeners = new EventListenerList2<WograldFailureListener>(WograldFailureListener.class);
    ...
    private final ClientSocketListener clientSocketListener = new ClientSocketListener() {
        ...
        public void connected() {
            DefaultWograldServerConnection.this.connected();
        }
     ...
     */
   // public DefaultWograldServerConnection(@Nullable final DebugWriter debugProtocol, @NotNull final String version) throws IOException {
       public DefaultWograldServerConnection(@Nullable final DebugWriter debugProtocol, @NotNull final String version, @Nullable final JOrbisPlayer player) throws IOException {
    ...
    public void addWograldServerConnectionListener(@NotNull final WograldServerConnectionListener listener) {
        wograldServerConnectionListeners.add(listener);
    }
    ...
    public void addWograldUpdateFaceListener(@NotNull final WograldUpdateFaceListener listener) {
        wograldUpdateFaceListeners.add(listener);
    }
    ...
    public void addWograldStatsListener(@NotNull final WograldStatsListener wograldStatsListener) {
        wograldStatsListeners.add(wograldStatsListener);
    }
    ...
    public void addWograldUpdateItemListener(@NotNull final WograldUpdateItemListener wograldUpdateItemListener) {
        wograldUpdateItemListeners.add(wograldUpdateItemListener);
    }
    ...
    public void removeWograldUpdateItemListener(@NotNull final WograldUpdateItemListener wograldUpdateItemListener) {
        wograldUpdateItemListeners.remove(wograldUpdateItemListener);
    }
    ...
    public void setWograldUpdateMapListener(@Nullable final WograldUpdateMapListener listener) {
        if (listener != null && wograldUpdateMapListener != null) {
            throw new IllegalStateException();
        }
        wograldUpdateMapListener = listener;
    }
    ...
    public void addWograldTickListener(@NotNull final WograldTickListener listener) {
        wograldTickListeners.add(listener);
    }
    ...
    public void addWograldSoundListener(@NotNull final WograldSoundListener listener) {
        wograldSoundListeners.add(listener);
    }
    ...
    public void addWograldSmoothListener(@NotNull final WograldSmoothListener listener) {
        wograldSmoothListeners.add(listener);
    }
    ...
    public void addWograldMusicListener(@NotNull final WograldMusicListener listener) {
        wograldMusicListeners.add(listener);
    }
    ...
    public void addWograldComcListener(@NotNull final WograldComcListener listener) {
        wograldComcListeners.add(listener);
    }
    ...
    public void addWograldFaceListener(@NotNull final WograldFaceListener listener) {
        wograldFaceListeners.add(listener);
    }
    ...
    public void addWograldSpellListener(@NotNull final WograldSpellListener listener) {
        wograldSpellListeners.add(listener);
    }
     ...
     */
    @Override
    public void addWograldQuestListener(@NotNull final WograldQuestListener listener) {
        wograldQuestListeners.add(listener);
    }
    ...
    public void addWograldAccountListener(@NotNull final WograldAccountListener listener) {
        wograldAccountListeners.add(listener);
    }
    ...
    public void removeWograldAccountListener(@NotNull final WograldAccountListener listener) {
        wograldAccountListeners.remove(listener);
    }
    ...
    public void addWograldExpTableListener(@NotNull final WograldExpTableListener wograldExpTableListener) {
        wograldExpTableListeners.add(wograldExpTableListener);
    }
    ...
    public void addWograldSkillInfoListener(@NotNull final WograldSkillInfoListener listener) {
        wograldSkillInfoListeners.add(listener);
    }
    ...
    public void removeWograldSkillInfoListener(@NotNull final WograldSkillInfoListener listener) {
        wograldSkillInfoListeners.remove(listener);
    }
    ...
    public void addWograldPickupListener(@NotNull final WograldPickupListener listener) {
        wograldPickupListeners.add(listener);
    }
    ...
    public void removeWograldPickupListener(@NotNull final WograldPickupListener listener) {
        wograldPickupListeners.remove(listener);
    }
    ...
    private void cmdMap2CoordinateClearSpace(final int x, final int y, final int floor, final int len) throws UnknownCommandException {
        ...
        assert wograldUpdateMapListener != null;
        wograldUpdateMapListener.mapClear(x, y,floor);
    }
    ...
    private void cmdMap2CoordinateDarkness(@NotNull final ByteBuffer packet, final int x, final int y, final int floor, final int len) throws UnknownCommandException {
        ...
        assert wograldUpdateMapListener != null;
        wograldUpdateMapListener.mapDarkness(x, y, darkness,floor);
    }
    ...
    private void cmdMap2CoordinateLayer(@NotNull final ByteBuffer packet, final int x, final int y, final int len, final int layer) throws UnknownCommandException {
        ...
        if ((face&Map2.FACE_ANIMATION) == 0) {
            ...
            assert wograldUpdateMapListener != null;
            wograldUpdateMapListener.mapFace(location, face);
            ...
            assert wograldUpdateMapListener != null;
            if((0 <= layer) && (layer < 3)){
           //     wograldUpdateMapListener.mapAnimation(location, face&Map2.ANIM_MASK, (face>>Map2.ANIM_TYPE_SHIFT)&Map2.ANIM_TYPE_MASK);
            }
    ...
    private void cmdMap2CoordinateLayer3(@NotNull final ByteBuffer packet, @NotNull final Location location, final int face) throws UnknownCommandException {
        ...
        if ((face&Map2.FACE_ANIMATION) == 0) {
            ...
            assert wograldUpdateMapListener != null;
            wograldUpdateMapListener.mapSmooth(location, smooth);
        } else {
            ...
            assert wograldUpdateMapListener != null;
            wograldUpdateMapListener.mapAnimationSpeed(location, animSpeed);
        }
    }
    ...
    private void processSkillInfoReplyinfo(@NotNull final ByteBuffer packet) throws IOException {
        for (final WograldSkillInfoListener wograldSkillInfoListener : wograldSkillInfoListeners.getListeners()) {
            wograldSkillInfoListener.clearSkills();
        }
        final byte[] data = new byte[packet.remaining()];
        packet.get(data);
        final ByteArrayInputStream is = new ByteArrayInputStream(data);
            ...
            try {
                ...
                try {
                    while (true) {
                        ...
                        if (skillId < WograldStatsListener.CS_STAT_SKILLINFO || skillId >= WograldStatsListener.CS_STAT_SKILLINFO+WograldStatsListener.CS_NUM_SKILLS) {
                            System.err.println("Ignoring skill definition for invalid skill id "+skillId+": "+r+".");
                            continue;
                        }

                        for (final WograldSkillInfoListener wograldSkillInfoListener : wograldSkillInfoListeners.getListeners()) {
                            wograldSkillInfoListener.addSkill(skillId, sk[1]);
                        }
                    }
                } finally {
                    d.close();
    ...
    private void processExpTableReplyinfo(@NotNull final ByteBuffer packet) {
        ...
        for (final WograldExpTableListener wograldExpTableListener : wograldExpTableListeners.getListeners()) {
            wograldExpTableListener.expTableReceived(expTable);
        }
        ...
        if (loginMethod == 0) {
         ...
         //   sendAddme();
            ...
            for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
                wograldAccountListener.manageAccount();
            }
        }
    }
    ...
    private void processAccountPlayers(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
            wograldAccountListener.startAccountList(accountName);
        }
        ...
        while (count > 0) {
            ...
            while (packet.hasRemaining()) {
                ...
                if (len == 0) {
                    ...
                    for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
                        wograldAccountListener.addAccount(name, cClass, race, face, party, map, level, faceNumber);
                    }
                    break;
                }
        ...
        for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
            wograldAccountListener.endAccountList();
        }
    ...
    private void processAddmeSuccess(@NotNull final ByteBuffer packet) {
        ...
        if (clientSocketState != ClientSocketState.CONNECTED) {
            if (clientSocketState == ClientSocketState.ADDME) {
                ...
                for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
                    wograldAccountListener.startPlaying();
                }
    ...
    private void processAddQuest(@NotNull final ByteBuffer packet) {
        ...
        while (packet.hasRemaining()) {
            ...
            for (final WograldQuestListener wograldQuestListener : wograldQuestListeners.getListeners()) {
                wograldQuestListener.addQuest(code, title, face, replay == 1, parent, end == 1, step);
            }
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processAddSpell(@NotNull final ByteBuffer packet) {
        ...
        while (packet.hasRemaining()) {
            ...
            for (final WograldSpellListener wograldSpellListener : wograldSpellListeners.getListeners()) {
                wograldSpellListener.addSpell(tag, level, castingTime, mana, grace, damage, skill, path, face, name, message);
            }
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processAnim(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        if (wograldUpdateMapListener != null) {
            wograldUpdateMapListener.addAnimation(num&0x1FFF, flags, faces);
        }
    ...
    private void processComc(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldComcListener listener : wograldComcListeners.getListeners()) {
    ...
    private void processDelInv(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldUpdateItemListener wograldUpdateItemListener : wograldUpdateItemListeners.getListeners()) {
            wograldUpdateItemListener.delinvReceived(tag);
        }
    ...
    private void processDelItem(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldUpdateItemListener wograldUpdateItemListener : wograldUpdateItemListeners.getListeners()) {
            wograldUpdateItemListener.delitemReceived(tags);
        }
    ...
    private void processDelSpell(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldSpellListener wograldSpellListener : wograldSpellListeners.getListeners()) {
            wograldSpellListener.deleteSpell(tag);
        }
        notifyPacketWatcherListenersIntArray(packet, args);
    }
    ...
    private void processFace2(@NotNull final ByteBuffer packet) {
       ...
       // for (final WograldUpdateFaceListener wograldUpdateFaceListener : wograldUpdateFaceListeners.getListeners()) {
        for (final WograldFaceListener wograldFaceListener : wograldFaceListeners.getListeners()) {
            wograldFaceListener.faceReceived(faceNum, faceSetNum, faceChecksum, faceQuad, faceName);
            
                   // packet.position(faceDataPosition);
           // wograldUpdateFaceListener.updateFace(faceNum, faceSetNum, packet);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processFailure(@NotNull final ByteBuffer packet) {
        ...
        for (final WograldFailureListener wograldFailureListener : wograldFailureListeners.getListeners()) {
            wograldFailureListener.failure(command, message);
        }
    }
    ...
    private void clearFailure() {
        for (final WograldFailureListener wograldFailureListener : wograldFailureListeners.getListeners()) {
            wograldFailureListener.clearFailure();
        }
    }
    ...
    private void processImage2(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldUpdateFaceListener listener : wograldUpdateFaceListeners.getListeners()) {
            packet.position(faceDataPosition);
    ...
    private void processItem2(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        while (packet.hasRemaining()) {
            ...
            for (final WograldUpdateItemListener wograldUpdateItemListener : wograldUpdateItemListeners.getListeners()) {
                wograldUpdateItemListener.addItemReceived(location, tag, flags, weight, faceNum, name, namePl, anim, animSpeed, nrof, type);
            }
        }
        if (packet.hasRemaining()) {
    ...
    private void processMagicMap(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        if (wograldUpdateMapListener != null) {
            synchronized (wograldUpdateMapListener.mapBegin()) {
                assert wograldUpdateMapListener != null;
                wograldUpdateMapListener.magicMap(-px+(currentMapWidth-1)/2, -py+(currentMapHeight-1)/2, data);
                assert wograldUpdateMapListener != null;
                wograldUpdateMapListener.mapEnd();
                // are you sure we need to do this if we also do this when updating main view
                // which redraws magicmap anyway?
            }
        }
        for (final WograldMagicmapListener listener : magicmapListeners.getListeners()) {
            ...
            synchronized (wograldUpdateMapListener.mapBegin()) {
                ...
                //    final int y = ((coord>>4)&0x3F);
                    ...
                    case Map2.TYPE_SCROLL:
                        ...
                        assert wograldUpdateMapListener != null;
                        wograldUpdateMapListener.mapScroll(x, y);
  ...
  private void processFloorChange(@NotNull final ByteBuffer packet){
      ...
      if(topFloor == 3){
          if(newTopFloor <= 2){
              wograldUpdateMapListener.eraseFloor(3);
              
          }
          if(newTopFloor <= 1){
              wograldUpdateMapListener.eraseFloor(2);
          }
          if(newTopFloor == 0){
              wograldUpdateMapListener.eraseFloor(1);
          }
      ...
      if(scrollreceivedcurrent){
          ...
          wograldUpdateMapListener.carveViewpoint(scrollx_current, scrolly_current,newTopFloor);
    ...
    private void processMusic(@NotNull final ByteBuffer packet) {
     ...
     //   }
/*
        for (final WograldMusicListener listener : wograldMusicListeners.getListeners()) {
...
System.out.println("discard repeat music\n");
    ...
    private void processPickup(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldPickupListener wograldPickupListener : wograldPickupListeners.getListeners()) {
            wograldPickupListener.pickupChanged(pickupOptions);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processPlayer(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldUpdateItemListener wograldUpdateItemListener : wograldUpdateItemListeners.getListeners()) {
            wograldUpdateItemListener.playerReceived(tag, weight, faceNum, name);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processQuery(@NotNull final ByteBuffer packet) throws UnknownCommandException {
      ...
      if (clientSocketState != ClientSocketState.CONNECTED) {
        ...
        for (final WograldQueryListener listener : queryListeners.getListeners()) {
    ...
    private void processSmooth(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldSmoothListener listener : wograldSmoothListeners.getListeners()) {
    ...
    private void processSound(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldSoundListener listener : wograldSoundListeners.getListeners()) {
    ...
    private void processStats(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        while (packet.hasRemaining()) {
            ...
            case WograldStatsListener.CS_STAT_MAXHP:
            case WograldStatsListener.CS_STAT_SP:
            case WograldStatsListener.CS_STAT_MAXSP:
            case WograldStatsListener.CS_STAT_STR:
            case WograldStatsListener.CS_STAT_INT:
            case WograldStatsListener.CS_STAT_WIS:
            case WograldStatsListener.CS_STAT_DEX:
            case WograldStatsListener.CS_STAT_CON:
            case WograldStatsListener.CS_STAT_CHA:
            case WograldStatsListener.CS_STAT_LEVEL:
            case WograldStatsListener.CS_STAT_WC:
            case WograldStatsListener.CS_STAT_AC:
            case WograldStatsListener.CS_STAT_DAM:
            case WograldStatsListener.CS_STAT_ARMOUR:
            case WograldStatsListener.CS_STAT_FOOD:
            case WograldStatsListener.CS_STAT_POW:
            case WograldStatsListener.CS_STAT_GRACE:
            case WograldStatsListener.CS_STAT_MAXGRACE:
            case WograldStatsListener.CS_STAT_FLAGS:
            case WograldStatsListener.CS_STAT_RACE_STR:
            case WograldStatsListener.CS_STAT_RACE_INT:
            case WograldStatsListener.CS_STAT_RACE_WIS:
            case WograldStatsListener.CS_STAT_RACE_DEX:
            case WograldStatsListener.CS_STAT_RACE_CON:
            case WograldStatsListener.CS_STAT_RACE_CHA:
            case WograldStatsListener.CS_STAT_RACE_POW:
            case WograldStatsListener.CS_STAT_BASE_STR:
            case WograldStatsListener.CS_STAT_BASE_INT:
            case WograldStatsListener.CS_STAT_BASE_WIS:
            case WograldStatsListener.CS_STAT_BASE_DEX:
            case WograldStatsListener.CS_STAT_BASE_CON:
            case WograldStatsListener.CS_STAT_BASE_CHA:
            case WograldStatsListener.CS_STAT_BASE_POW:
            case WograldStatsListener.CS_STAT_APPLIED_STR:
            case WograldStatsListener.CS_STAT_APPLIED_INT:
            case WograldStatsListener.CS_STAT_APPLIED_WIS:
            case WograldStatsListener.CS_STAT_APPLIED_DEX:
            case WograldStatsListener.CS_STAT_APPLIED_CON:
            case WograldStatsListener.CS_STAT_APPLIED_CHA:
            case WograldStatsListener.CS_STAT_APPLIED_POW:
            case WograldStatsListener.CS_STAT_GOLEM_HP:
            case WograldStatsListener.CS_STAT_GOLEM_MAXHP:
                ...
                for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                    wograldStatsListener.statInt2Received(stat, int2Param);
                }
                notifyPacketWatcherListenersStats(stat, int2Param);
                break;

            case WograldStatsListener.CS_STAT_EXP:
            case WograldStatsListener.CS_STAT_SPEED:
            case WograldStatsListener.CS_STAT_WEAP_SP:
            case WograldStatsListener.CS_STAT_WEIGHT_LIM:
            case WograldStatsListener.CS_STAT_SPELL_ATTUNE:
            case WograldStatsListener.CS_STAT_SPELL_REPEL:
            case WograldStatsListener.CS_STAT_SPELL_DENY:
                final int int4Param = getInt4(packet);
                if (debugProtocol != null) {
                    debugProtocol.debugProtocolWrite("recv stats stat="+stat+" int4="+int4Param);
                }
                for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                    wograldStatsListener.statInt4Received(stat, int4Param);
                }
                notifyPacketWatcherListenersStats(stat, int4Param);
                break;

            case WograldStatsListener.CS_STAT_EXP64:
                final long int8Param = getInt8(packet);
                if (debugProtocol != null) {
                    debugProtocol.debugProtocolWrite("recv stats stat="+stat+" int8="+int8Param);
                }
                for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                    wograldStatsListener.statInt8Received(stat, int8Param);
                }
                notifyPacketWatcherListenersStats(stat, int8Param);
                break;

            case WograldStatsListener.CS_STAT_RANGE:
            case WograldStatsListener.CS_STAT_TITLE:
                ...
                for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                    wograldStatsListener.statStringReceived(stat, strParam);
                }
                notifyPacketWatcherListenersStats(stat, strParam);
                break;

            default:
                if (WograldStatsListener.CS_STAT_RESIST_START <= stat && stat < WograldStatsListener.CS_STAT_RESIST_START+WograldStatsListener.RESIST_TYPES) {
                    final short int2Param2 = (short)getInt2(packet);
                    if (debugProtocol != null) {
                        debugProtocol.debugProtocolWrite("recv stats stat="+stat+" int2="+int2Param2);
                    }
                    for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                        wograldStatsListener.statInt2Received(stat, int2Param2);
                    }
                    notifyPacketWatcherListenersStats(stat, int2Param2);
                } else if (WograldStatsListener.CS_STAT_SKILLINFO <= stat && stat < WograldStatsListener.CS_STAT_SKILLINFO+WograldStatsListener.CS_NUM_SKILLS) {
                    ...
                    for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
                        wograldStatsListener.statSkillReceived(stat, level, experience);
                    }
    ...
    private void processTick(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldTickListener listener : wograldTickListeners.getListeners()) {
    ...
    private void processUpdItem(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldUpdateItemListener wograldUpdateItemListener : wograldUpdateItemListeners.getListeners()) {
            wograldUpdateItemListener.upditemReceived(flags, tag, valLocation, valFlags, valWeight, valFaceNum, valName, valNamePl, valAnim, valAnimSpeed, valNrof);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processUpdQuest(@NotNull final ByteBuffer packet) {
        ...
        for (final WograldQuestListener wograldQuestListener : wograldQuestListeners.getListeners()) {
            wograldQuestListener.updateQuest(code, end == 1, step);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processUpdSpell(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        final int flags = getInt1(packet);
        final int tag = getInt4(packet);
        final int mana = (flags&WograldSpellListener.UPD_SP_MANA) == 0 ? 0 : getInt2(packet);
        final int grace = (flags&WograldSpellListener.UPD_SP_GRACE) == 0 ? 0 : getInt2(packet);
        final int damage = (flags&WograldSpellListener.UPD_SP_DAMAGE) == 0 ? 0 : getInt2(packet);
        if (packet.hasRemaining()) {
        ...
        for (final WograldSpellListener wograldSpellListener : wograldSpellListeners.getListeners()) {
            wograldSpellListener.updateSpell(flags, tag, mana, grace, damage);
        }
        notifyPacketWatcherListenersMixed(packet, args);
    }
    ...
    private void processVersion(@NotNull final ByteBuffer packet) throws UnknownCommandException {
        ...
        for (final WograldStatsListener wograldStatsListener : wograldStatsListeners.getListeners()) {
            wograldStatsListener.setSimpleWeaponSpeed(scval >= 1029);
        }
    ...
    public void drawInfo(@NotNull final String message, final int color) {
        for (final WograldDrawinfoListener listener : drawinfoListeners.getListeners()) {
    ...
    public void drawextinfo(final int color, final int type, final int subtype, final String message) {
        for (final WograldDrawextinfoListener listener : drawextinfoListeners.getListeners()) {
    ...
    private void fireNewMap() {
        if (wograldUpdateMapListener != null) {
            wograldUpdateMapListener.newMap(currentMapWidth, currentMapHeight);
        }
    ...
    private void setClientSocketState(@NotNull final ClientSocketState prevState, @NotNull final ClientSocketState nextState) {
        ...
        for (final WograldServerConnectionListener wograldServerConnectionListener : wograldServerConnectionListeners.getListeners()) {
            wograldServerConnectionListener.clientSocketStateChanged(nextState);
        }
    }
    ...
    public void sendAccountPlay(@NotNull final String name) {
        ...
        if (tmpAccountName != null) {
            for (final WograldAccountListener wograldAccountListener : wograldAccountListeners.getListeners()) {
                wograldAccountListener.selectCharacter(tmpAccountName, name);
            }
        }
    }
    ...
    public void addWograldFailureListener(@NotNull final WograldFailureListener listener) {
        wograldFailureListeners.add(listener);
    }
    ...
    public void removeWograldFailureListener(@NotNull final WograldFailureListener listener) {
        wograldFailureListeners.remove(listener);
    }
