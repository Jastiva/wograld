...
public class ScriptkillCommand extends AbstractCommand {
     ...
     */
    public ScriptkillCommand(@NotNull final ScriptManager scriptManager, @NotNull final WograldServerConnection wograldServerConnection) {
        super("scriptkill", wograldServerConnection);
