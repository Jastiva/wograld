...
public class PerfTestMapDecode {
    ...
    public static void main(final String... args) throws Throwable {
        ...
        for (final Method performanceTestMethod : performanceTestMethods) {
            ...
            //System.out.println(sum + " " + performanceTestMethod);
        }
    ...
    /*@PerfTest("RandomAccessFile, startsWith")
    public static void currentRA() throws IOException {
        final RandomAccessFile in = new RandomAccessFile(testFileName, "r");
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
                line = line.trim();
    ...
    /*@PerfTest("RandomAccessFile, word by regex split of java.lang.String")
    public static void splitEqualsStringRA() throws IOException {
        final RandomAccessFile in = new RandomAccessFile(testFileName, "r");
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("RandomAccessFile, word by regex split of java.util.regex.Pattern")
    public static void splitEqualsPatternRA() throws IOException {
        final RandomAccessFile in = new RandomAccessFile(testFileName, "r");
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("RandomAccessFile, manual word split using String.indexOf(' ')")
    public static void manualEqualsRA() throws IOException {
        final RandomAccessFile in = new RandomAccessFile(testFileName, "r");
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("DataInputStream, startsWith (current)")
    public static void currentDI() throws IOException {
        final DataInputStream in = new DataInputStream(new FileInputStream(testFileName));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
                line = line.trim();
    ...
    /*@PerfTest("DataInputStream, word by regex split of java.lang.String")
    public static void splitEqualsStringDI() throws IOException {
        final DataInputStream in = new DataInputStream(new FileInputStream(testFileName));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("DataInputStream, word by regex split of java.util.regex.Pattern")
    public static void splitEqualsPatternDI() throws IOException {
        final DataInputStream in = new DataInputStream(new FileInputStream(testFileName));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("DataInputStream, manual word split using String.indexOf(' ')")
    public static void manualEqualsDI() throws IOException {
        final DataInputStream in = new DataInputStream(new FileInputStream(testFileName));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("Buffered DataInputStream, startsWith (current)")
    public static void currentBDI() throws IOException {
        final DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream(testFileName)));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
                line = line.trim();
    ...
    /*@PerfTest("Buffered DataInputStream, word by regex split of java.lang.String")
    public static void splitEqualsStringBDI() throws IOException {
        final DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream(testFileName)));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("Buffered DataInputStream, word by regex split of java.util.regex.Pattern")
    public static void splitEqualsPatternBDI() throws IOException {
        final DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream(testFileName)));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
    ...
    /*@PerfTest("Buffered DataInputStream, manual word split using String.indexOf(' ')")
    public static void manualEqualsBDI() throws IOException {
        final DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream(testFileName)));
        int state = 0;
        try {
            for (String line; (line = in.readLine()) != null;) {
