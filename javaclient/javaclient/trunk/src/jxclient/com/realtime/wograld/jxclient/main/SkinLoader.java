...
import com.realtime.wograld.jxclient.skin.source.JXCSkinClassSource;
import com.realtime.wograld.jxclient.skin.source.JXCSkinDirSource;
...
public class SkinLoader {
     ...
     */
    public SkinLoader(@NotNull final CommandCallback commandCallback, @NotNull final MetaserverModel metaserverModel, @Nullable final Resolution resolution, @NotNull final Macros macros, @NotNull final JXCWindowRenderer windowRenderer, @NotNull final WograldServerConnection server, @NotNull final GuiStateManager guiStateManager, @NotNull final TooltipManager tooltipManager, @NotNull final CommandQueue commandQueue, @NotNull final JXCSkinLoader skinLoader, @NotNull final Commands commands, @NotNull final Shortcuts shortcuts, @NotNull final CharacterModel characterModel, @NotNull final SmoothFaces smoothFaces, @NotNull final GUICommandFactory guiCommandFactory) {
    ...
    public JXCSkin loadSkin(@NotNull final String skinName) throws JXCSkinException {
        ...
        if (dir.exists() && dir.isDirectory()) {
            ...
            skinSource = new JXCSkinClassSource("com/realtime/wograld/jxclient/skins/"+skinName);
        }
