 ...
 */
public class EnvironmentMapError<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> extends GameObjectValidationError<G, A, R> {
     ...
     */
    public EnvironmentMapError(@NotNull final G gameObject, @NotNull final String typeDescription) {
        super(gameObject);
