...
public class JXCConnection {
    ...
    /**
     * The default port number for Wograld servers.
     */
    private static final int DEFAULT_WOGRALD_PORT = 13327;
    ...
    /**
     * The {@link WograldServerConnection} instance used to connect to the
     * Wograld server.
     */
    @NotNull
    ...
    /**
     * The {@link WograldPickupListener} for tracking pickup mode changes.
     */
    @NotNull
    private final WograldPickupListener wograldPickupListener = new WograldPickupListener() {
     ...
     * @param server the wograld server connection instance used to connect
     * @param guiStateManager the gui state manager to watch
     */
    public JXCConnection(@NotNull final KeybindingsManager keybindingsManager, @NotNull final Shortcuts shortcuts, @NotNull final Settings settings, @NotNull final Pickup characterPickup, @NotNull final WograldServerConnection server, @NotNull final GuiStateManager guiStateManager) {
    ...
    public void setCharacter(@Nullable final String character) {
        ...
        if (hostname != null && this.character != null) {
            server.removeWograldPickupListener(wograldPickupListener);
        ...
        if (hostname != null && character != null) {
            ...
            server.addWograldPickupListener(wograldPickupListener);
        }
    }
    ...
    public void setHost(@Nullable final String serverInfo) {
        ...
        if (serverInfo == null) {
            ...
            newHostname = tmp[0];
            newPort = tmp.length < 2 ? DEFAULT_WOGRALD_PORT : NumberParser.parseInt(tmp[1], DEFAULT_WOGRALD_PORT, 1, 65535);
        }
    ...
    /**
     * Disconnects from the Wograld server.
    ...
    /**
     * Connects to the Wograld server.
     */
