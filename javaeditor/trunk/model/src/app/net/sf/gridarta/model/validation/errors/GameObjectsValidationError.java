 ...
 */
public class GameObjectsValidationError<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> extends SquareValidationError<G, A, R> {
     ...
     */
    public GameObjectsValidationError(@NotNull final MapSquare<G, A, R> mapSquare, @NotNull final G gameObject) {
        super(mapSquare);
