...
package net.sf.gridarta.var.daimonin.resource;
...
import net.sf.gridarta.var.daimonin.model.collectable.DaimoninArchetypeSetCollectable;
...
public class DefaultResources extends AbstractResources<GameObject, MapArchObject, Archetype> {
    ...
    protected void readFilesInt(@NotNull final GlobalSettings globalSettings, @NotNull final ErrorView errorView, @NotNull final List<GameObject> invObjects) {
        ...
        loadArtifacts(errorView, invObjects, globalSettings.getCollectedDirectory(), globalSettings.getMapsDirectory());
    }
    ...
    protected void writeCollectedInt(@NotNull final Progress progress, @NotNull final File collectedDirectory) throws IOException {
        ...
        collectedResourcesWriter.addCollectable(new DaimoninArchetypeSetCollectable(archetypeSet));
     ...
     */
    private void loadArtifacts(@NotNull final ErrorView errorView, @NotNull final List<GameObject> invObjects, @NotNull final File collectedDirectory, @NotNull final File mapsDirectory) {
        ...
        artifactParser.loadArchesFromArtifacts(mapsDirectory, "Artifacts", "maps");
    }
