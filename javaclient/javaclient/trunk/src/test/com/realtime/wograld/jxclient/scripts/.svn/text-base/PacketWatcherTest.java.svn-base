...
import com.realtime.wograld.jxclient.test.TestWograldServerConnection;
import com.realtime.wograld.jxclient.test.TestScriptProcess;
...
public class PacketWatcherTest {
    ...
    public void test1() {
        ...
        final WograldServerConnection connection = new TestWograldServerConnection() {
