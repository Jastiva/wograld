...
/**
 * An {@link ArchetypeAttribute} for selecting animation names.
 * @author <a href="mailto:andi.vogl@gmx.net">Andreas Vogl</a>
 * @author Andreas Kirschbaum
 */
public class ArchetypeAttributeAnimationName extends ArchetypeAttribute {
     ...
     * @param sectionName the section name for the new attribute faces
     */
    public ArchetypeAttributeAnimationName(@NotNull final String archetypeAttributeName, @NotNull final String attributeName, @NotNull final String description, final int inputLength, @NotNull final String sectionName) {
