...
public class ScriptCommand extends AbstractCommand {
     ...
     */
    public ScriptCommand(@NotNull final ScriptManager scriptManager, @NotNull final WograldServerConnection wograldServerConnection) {
        super("script", wograldServerConnection);
