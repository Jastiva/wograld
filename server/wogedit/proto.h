...
extern int png_to_xpixmap(Display *display, Drawable draw, char *data, int len, int num,Colormap *cmap);
extern int ReadImages(Display *gdisp, Colormap *cmap, enum DisplayMode type);
extern void free_pixmaps(Display *gdisp );
