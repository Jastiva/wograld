...
import com.realtime.wograld.jxclient.server.socket.ClientSocket;
...
public abstract class DefaultServerConnection implements ServerConnection {
    ...
    /**
     * The {@link ClientSocket} instance used to connect to Wograld servers.
     */
    @NotNull
    ...
    /**
     * Writes a Wograld Message on the socket, so it is sent to the server.
