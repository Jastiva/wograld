...
import com.realtime.wograld.jxclient.quests.Quest;
import com.realtime.wograld.jxclient.quests.QuestListener;
import com.realtime.wograld.jxclient.quests.QuestsManager;
import com.realtime.wograld.jxclient.quests.QuestsManagerListener;
...
public class GUIItemQuest extends GUIItemItem {
    ...
    public GUIItemQuest(@NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final String name, @NotNull final ItemPainter itemPainter, final int defaultIndex, @NotNull final FacesManager facesManager, @NotNull final QuestsManager questsManager, @NotNull final QuestsView questsView) {
        ...
        this.questsManager.addWograldQuestChangedListener(questsManagerListener);
    ...
    public void dispose() {
        super.dispose();
        questsManager.removeWograldQuestChangedListener(questsManagerListener);
