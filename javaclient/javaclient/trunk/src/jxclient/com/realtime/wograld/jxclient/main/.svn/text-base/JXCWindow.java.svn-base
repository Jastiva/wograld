...
import com.realtime.wograld.jxclient.account.CharacterInformation;
...
import com.realtime.wograld.jxclient.window.DialogStateParser;
...
public class JXCWindow {
    ...
    /**
     * The {@link WograldServerConnection} to use.
     */
    @NotNull
    ...
    /**
     * The {@link WograldQueryListener} attached to {@link #server}. It parses
    ...
    private final GuiStateListener guiStateListener = new GuiStateListener() {
        ...
        @Override
        public void start() {
            server.removeWograldQueryListener(wograldQueryListener);
        ...
        public void connecting(@NotNull final String serverInfo) {
            server.addWograldQueryListener(wograldQueryListener);
    ...
    /**
     * The {@link WograldAccountListener} attached to {@link #server}.
     */
    @NotNull
    private final WograldAccountListener accountListener = new WograldAccountListener() {
     ...
     * @param server the wograld server connection to use
     ...
     */
    public JXCWindow(@NotNull final Exiter exiter, @NotNull final WograldServerConnection server, @NotNull final OptionManager optionManager, @NotNull final GuiStateManager guiStateManager, @NotNull final JXCWindowRenderer windowRenderer, @NotNull final CommandQueue commandQueue, @NotNull final GuiManager guiManager, @NotNull final KeyHandler keyHandler, @NotNull final CharacterModel characterModel, @NotNull final JXCConnection connection) {
        this.exiter = exiter;
        this.server = server;
        ...
        server.addWograldAccountListener(accountListener);
