...
/**
 * An {@link ArchetypeAttribute} for selecting script files.
...
public class ArchetypeAttributeScriptFile extends ArchetypeAttribute {
     ...
     */
    public ArchetypeAttributeScriptFile(@NotNull final String archetypeAttributeName, @NotNull final String attributeName, @NotNull final String description, final int inputLength, @NotNull final String sectionName) {
