/*****************************************************************************/
/* Wograld timers support - (C) 2001 by Yann Chachkoff.                    */
...
/* You can either count the time in seconds or in "wograld cycles".        */
...
/* in wograld cycles. For example, if a timer is to be triggered 10 seconds*/
/* later, delay = 10.                                                        */
/*****************************************************************************/
/* Timer limits.                                                             */
