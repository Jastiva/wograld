...
public class DefaultScriptArchUtils extends AbstractScriptArchUtils {
    ...
    @NotNull
    @Override
    public String getArchetypeNameForEventType(final int eventType) throws UndefinedEventArchetypeTypeException {
        final String typeName = getEventType(eventType);
        if (typeName == null) {
            throw new UndefinedEventArchetypeTypeException(eventType);
        }
