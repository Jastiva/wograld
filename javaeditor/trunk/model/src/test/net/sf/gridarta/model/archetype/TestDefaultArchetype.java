...
/**
 * An {@link Archetype} implementation for testing purposes.
...
public class TestDefaultArchetype extends AbstractArchetype<TestGameObject, TestMapArchObject, TestArchetype> implements TestArchetype {
    ...
    /**
     * The return value of {@link #usesDirection()}.
     */
     ...
     */
    public TestDefaultArchetype(@NotNull final String archetypeName, @NotNull final FaceObjectProviders faceObjectProviders, @NotNull final AnimationObjects animationObjects) {
