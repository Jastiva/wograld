/*****************************************************************************/
/* Wograld plugin support - (C) 2001 by Yann Chachkoff.                    */
...
typedef struct _wograld_plugin
{
    ...
    struct _wograld_plugin *next;
    struct _wograld_plugin *prev;
} wograld_plugin;

extern int plugin_number;
extern wograld_plugin* plugins_list;
