...
public class ExecCommand extends AbstractCommand {
     ...
     */
    public ExecCommand(@NotNull final CommandCallback commandCallback, @NotNull final WograldServerConnection wograldServerConnection) {
        super("exec", wograldServerConnection);
