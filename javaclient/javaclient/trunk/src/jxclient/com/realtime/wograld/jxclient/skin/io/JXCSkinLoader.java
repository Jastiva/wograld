...
package com.realtime.wograld.jxclient.skin.io;
...
import com.realtime.wograld.jxclient.faces.FacesProviderFactory;
import com.realtime.wograld.jxclient.faces.SmoothFaces;
import com.realtime.wograld.jxclient.gui.GUIFill;
import com.realtime.wograld.jxclient.gui.GUIPicture;
import com.realtime.wograld.jxclient.gui.button.ButtonImages;
import com.realtime.wograld.jxclient.gui.button.GUIButton;
import com.realtime.wograld.jxclient.gui.commands.CommandCallback;
import com.realtime.wograld.jxclient.gui.commands.CommandCheckBoxOption;
...
import com.realtime.wograld.jxclient.gui.gauge.GUIDupGauge;
import com.realtime.wograld.jxclient.gui.gauge.GUIDupTextGauge;
import com.realtime.wograld.jxclient.gui.gauge.GUIGauge;
import com.realtime.wograld.jxclient.gui.gauge.GUITextGauge;
import com.realtime.wograld.jxclient.gui.gauge.GaugeUpdater;
import com.realtime.wograld.jxclient.gui.gauge.Orientation;
...
import com.realtime.wograld.jxclient.gui.gui.GUIScrollBar;
...
import com.realtime.wograld.jxclient.gui.gui.RendererGuiState;
import com.realtime.wograld.jxclient.gui.gui.TooltipManager;
import com.realtime.wograld.jxclient.gui.item.GUIItemFloor;
import com.realtime.wograld.jxclient.gui.item.GUIItemFloorFactory;
import com.realtime.wograld.jxclient.gui.item.GUIItemInventory;
import com.realtime.wograld.jxclient.gui.item.GUIItemInventoryFactory;
import com.realtime.wograld.jxclient.gui.item.GUIItemItemFactory;
import com.realtime.wograld.jxclient.gui.item.GUIItemQuestListFactory;
import com.realtime.wograld.jxclient.gui.item.GUIItemShortcut;
import com.realtime.wograld.jxclient.gui.item.GUIItemSpell;
import com.realtime.wograld.jxclient.gui.item.GUIItemSpellListFactory;
import com.realtime.wograld.jxclient.gui.item.ItemPainter;
import com.realtime.wograld.jxclient.gui.keybindings.InvalidKeyBindingException;
...
import com.realtime.wograld.jxclient.gui.label.Alignment;
import com.realtime.wograld.jxclient.gui.label.GUIHTMLLabel;
import com.realtime.wograld.jxclient.gui.label.GUILabelFailure;
import com.realtime.wograld.jxclient.gui.label.GUILabelMessage;
import com.realtime.wograld.jxclient.gui.label.GUILabelQuery;
import com.realtime.wograld.jxclient.gui.label.GUILabelStats;
import com.realtime.wograld.jxclient.gui.label.GUILabelStats2;
import com.realtime.wograld.jxclient.gui.label.GUIMultiLineLabel;
import com.realtime.wograld.jxclient.gui.label.GUIOneLineLabel;
import com.realtime.wograld.jxclient.gui.label.GUISpellLabel;
import com.realtime.wograld.jxclient.gui.label.Type;
import com.realtime.wograld.jxclient.gui.list.GUICharacterList;
import com.realtime.wograld.jxclient.gui.list.GUIFloorList;
import com.realtime.wograld.jxclient.gui.list.GUIItemList;
import com.realtime.wograld.jxclient.gui.list.GUIMetaElementList;
import com.realtime.wograld.jxclient.gui.list.GUIQuestList;
import com.realtime.wograld.jxclient.gui.list.GUISpellList;
import com.realtime.wograld.jxclient.gui.log.Fonts;
import com.realtime.wograld.jxclient.gui.log.GUILabelLog;
import com.realtime.wograld.jxclient.gui.log.GUIMessageLog;
import com.realtime.wograld.jxclient.gui.log.MessageBufferUpdater;
import com.realtime.wograld.jxclient.gui.map.GUIMap;
import com.realtime.wograld.jxclient.gui.map.GUIMiniMap;
import com.realtime.wograld.jxclient.gui.scrollable.GUIScrollable2;
import com.realtime.wograld.jxclient.gui.textinput.GUICommandText;
import com.realtime.wograld.jxclient.gui.textinput.GUIQueryText;
import com.realtime.wograld.jxclient.gui.textinput.GUIText;
import com.realtime.wograld.jxclient.gui.textinput.GUITextField;
...
import com.realtime.wograld.jxclient.skin.events.ConnectionStateSkinEvent;
import com.realtime.wograld.jxclient.skin.events.WograldMagicmapSkinEvent;
import com.realtime.wograld.jxclient.skin.events.MapScrollSkinEvent;
import com.realtime.wograld.jxclient.skin.events.SkillAddedSkinEvent;
import com.realtime.wograld.jxclient.skin.events.SkillRemovedSkinEvent;
import com.realtime.wograld.jxclient.skin.factory.CheckBoxFactory;
import com.realtime.wograld.jxclient.skin.factory.DialogFactory;
import com.realtime.wograld.jxclient.skin.factory.TextButtonFactory;
import com.realtime.wograld.jxclient.skin.skin.DefaultJXCSkin;
import com.realtime.wograld.jxclient.skin.skin.Dialogs;
import com.realtime.wograld.jxclient.skin.skin.Expression;
import com.realtime.wograld.jxclient.skin.skin.Extent;
import com.realtime.wograld.jxclient.skin.skin.JXCSkin;
import com.realtime.wograld.jxclient.skin.skin.JXCSkinCache;
import com.realtime.wograld.jxclient.skin.skin.JXCSkinException;
import com.realtime.wograld.jxclient.skin.source.JXCSkinSource;
import com.realtime.wograld.jxclient.spells.CurrentSpellManager;
...
import com.realtime.wograld.jxclient.util.NumberParser;
import com.realtime.wograld.jxclient.util.Resolution;
import com.realtime.wograld.jxclient.util.ResourceUtils;
import com.realtime.wograld.jxclient.util.StringUtils;
import com.realtime.wograld.jxclient.util.UnterminatedTokenException;
...
public class JXCSkinLoader {
     ...
     * WograldServerConnection, CurrentSpellManager, Image, Image)}.
     */
     ...
     * @param wograldServerConnection the server connection to attach to
    ...
    public JXCSkin load(@NotNull final JXCSkinSource skinSource, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final GuiStateManager guiStateManager, @NotNull final TooltipManager tooltipManager, @NotNull final JXCWindowRenderer windowRenderer, @NotNull final GUIElementListener elementListener, @NotNull final MetaserverModel metaserverModel, @NotNull final CharacterModel characterModel, @NotNull final CommandQueue commandQueue, @NotNull final Shortcuts shortcuts, @NotNull final Commands commands, @NotNull final CurrentSpellManager currentSpellManager, @NotNull final CommandCallback commandCallback, @NotNull final Macros macros, @NotNull final GuiFactory guiFactory, @NotNull final SmoothFaces smoothFaces) throws JXCSkinException {
        ...
        try {
            ...
            try {
                load(skinSource, "global", wograldServerConnection, guiStateManager, tooltipManager, windowRenderer, elementListener, metaserverModel, characterModel, commandQueue, null, shortcuts, commands, currentSpellManager, commandCallback, macros, nextGroupFace, prevGroupFace, smoothFaces);
                while (true) {
                    ...
                    load(skinSource, name, wograldServerConnection, guiStateManager, tooltipManager, windowRenderer, elementListener, metaserverModel, characterModel, commandQueue, gui, shortcuts, commands, currentSpellManager, commandCallback, macros, nextGroupFace, prevGroupFace, smoothFaces);
                }
            } finally {
                definedFonts.clear();
                textButtonFactory = null;
     ...
     * @throws JXCSkinException if the file cannot be loaded
     */
    private void load(@NotNull final JXCSkinSource skinSource, @NotNull final String dialogName, @NotNull final String resourceName, @NotNull final InputStream inputStream, @NotNull final WograldServerConnection server, @NotNull final GuiStateManager guiStateManager, @NotNull final TooltipManager tooltipManager, @NotNull final JXCWindowRenderer windowRenderer, @NotNull final GUIElementListener elementListener, @NotNull final MetaserverModel metaserverModel, @NotNull final CharacterModel characterModel, @NotNull final CommandQueue commandQueue, @Nullable final Gui gui, @NotNull final Shortcuts shortcuts, @NotNull final Commands commands, @NotNull final CurrentSpellManager currentSpellManager, @NotNull final CommandCallback commandCallback, @NotNull final Macros macros, @NotNull final Image nextGroupFace, @NotNull final Image prevGroupFace, @NotNull final SmoothFaces smoothFaces) throws JXCSkinException {
        try {
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseEvent(@NotNull final Args args, @NotNull final GuiStateManager guiStateManager, @NotNull final WograldServerConnection server) throws IOException, JXCSkinException {
        final String type = args.get();
        if (type.equals("connect")) {
            ...
            final CommandList commandList = skin.getCommandList(args.get());
            skin.addSkinEvent(new WograldMagicmapSkinEvent(commandList, server));
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseItem(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final CommandQueue commandQueue, @NotNull final WograldServerConnection server, @NotNull final Shortcuts shortcuts, @NotNull final CurrentSpellManager currentSpellManager, @NotNull final Image nextGroupFace, @NotNull final Image prevGroupFace) throws IOException, JXCSkinException {
        final String type = args.get();
        final String name = args.get();
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseLabelQuery(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final WograldServerConnection server) throws IOException, JXCSkinException {
        final String name = args.get();
        final Font font = definedFonts.lookup(args.get());
        final Color color = ParseUtils.parseColor(args.get());
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseLabelMessage(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final WograldServerConnection server, @NotNull final JXCWindowRenderer windowRenderer) throws IOException, JXCSkinException {
        final String name = args.get();
        final Font font = definedFonts.lookup(args.get());
        final Color color = ParseUtils.parseColor(args.get());
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseLabelFailure(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final WograldServerConnection server) throws IOException, JXCSkinException {
        final String name = args.get();
        final Font font = definedFonts.lookup(args.get());
        final Color color = ParseUtils.parseColor(args.get());
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseLogMessage(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final WograldServerConnection server) throws IOException, JXCSkinException {
        final String name = args.get();
        final Image backgroundImage = args.get().equals("null") ? null : imageParser.getImage(args.getPrev());
        final Font fontPrint = definedFonts.lookup(args.get());
        final Font fontFixed = definedFonts.lookup(args.get());
     ...
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseMap(@NotNull final Args args, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final WograldServerConnection server, @NotNull final SmoothFaces smoothFaces) throws IOException, JXCSkinException {
        final String name = args.get();
     ...
     * @param args the command arguments
     * @param server the wograld server connection for sending reply commands
     * @param commandCallback the command callback to use
     * @param tooltipManager the tooltip manager to update
     * @param elementListener the element listener to notify
     * @throws IOException if the command cannot be parsed
     * @throws JXCSkinException if the command cannot be parsed
     */
    private void parseQueryText(@NotNull final Args args, @NotNull final WograldServerConnection server, @NotNull final CommandCallback commandCallback, @NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener) throws IOException, JXCSkinException {
        final String name = args.get();
        final Image activeImage = imageParser.getImage(args.get());
        final Image inactiveImage = imageParser.getImage(args.get());
        final Font font = definedFonts.lookup(args.get());
