...
package net.sf.gridarta.var.daimonin.model.settings;
...
/**
 * An {@link AbstractConfigSource} that reads individual files from Crossfire's
 * arch directory.
 * @author Andreas Kirschbaum
 */
public class FilesConfigSource extends AbstractConfigSource {
    ...
    public <G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> void read(@NotNull final GlobalSettings globalSettings, @NotNull final AbstractResources<G, A, R> resources, @NotNull final ErrorView errorView) {
        resources.readFiles(globalSettings, errorView);
    }
