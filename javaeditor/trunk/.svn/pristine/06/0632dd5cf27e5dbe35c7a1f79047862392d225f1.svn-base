...
package net.sf.gridarta.var.atrinik.model.collectable;
 ...
 */
public class AtrinikArchetypeSetCollectable extends AbstractArchetypeSetCollectable<GameObject, MapArchObject, Archetype> {
     ...
     * objects
     */
    public AtrinikArchetypeSetCollectable(@NotNull final ArchetypeSet<GameObject, MapArchObject, Archetype> archetypeSet, @NotNull final GameObjectParser<GameObject, MapArchObject, Archetype> gameObjectParser) {
     ...
     */
    private static void writeArchetype(@NotNull final Writer writer, @NotNull final net.sf.gridarta.model.archetype.Archetype<GameObject, MapArchObject, Archetype> archetype, final boolean isHeadPart, @NotNull final GameObjectParser<GameObject, MapArchObject, Archetype> gameObjectParser) throws IOException {
