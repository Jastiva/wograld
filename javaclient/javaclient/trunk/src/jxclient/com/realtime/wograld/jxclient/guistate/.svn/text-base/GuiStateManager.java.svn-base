...
public class GuiStateManager {
    ...
    /**
     * The {@link WograldServerConnectionListener} used to detect connection
     * progress changes.
     */
    @NotNull
    private final WograldServerConnectionListener wograldServerConnectionListener = new WograldServerConnectionListener() {
     ...
     * monitor
     */
    public GuiStateManager(@NotNull final WograldServerConnection wograldServerConnection) {
        wograldServerConnection.addWograldServerConnectionListener(wograldServerConnectionListener);
