...
/**
 * Interface for listeners interested in events related to {@link
...
public interface MapViewManagerListener<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> {
     ...
     * @param mapView the new map view or <code>null</code> if no opened map
     * view exists
     */
     ...
     * @param mapView the created map view
     */
