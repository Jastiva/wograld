...
public class BindCommand extends AbstractCommand {
     ...
     */
    public BindCommand(@NotNull final WograldServerConnection wograldServerConnection, @NotNull final CommandCallback commandCallback, @NotNull final GUICommandFactory guiCommandFactory) {
        super("bind", wograldServerConnection);
