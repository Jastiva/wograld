...
public class ScriptkillallCommand extends AbstractCommand {
     ...
     */
    public ScriptkillallCommand(@NotNull final ScriptManager scriptManager, @NotNull final WograldServerConnection wograldServerConnection) {
        super("scriptkillall", wograldServerConnection);
