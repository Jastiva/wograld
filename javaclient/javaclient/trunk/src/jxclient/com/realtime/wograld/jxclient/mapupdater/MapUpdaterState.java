...
import com.realtime.wograld.jxclient.animations.Animation;
import com.realtime.wograld.jxclient.animations.Animations;
import com.realtime.wograld.jxclient.faces.Face;
import com.realtime.wograld.jxclient.faces.FacesManager;
import com.realtime.wograld.jxclient.faces.FacesManagerListener;
import com.realtime.wograld.jxclient.guistate.GuiStateManager;
import com.realtime.wograld.jxclient.map.CfMap;
import com.realtime.wograld.jxclient.map.CfMapAnimations;
 ...
 * com.realtime.wograld.jxclient.server.socket.ClientSocket} reading commands
 * received from the Wograld server, and {@link com.realtime.wograld.jxclient.faces.FileCacheFaceQueue}
 * reading faces from the (file) cache. Synchronization is by {@link #sync} and
 * applies to the whole map model {@link #map}.
 * @author Andreas Kirschbaum
 */
public class MapUpdaterState implements WograldTickListener, WograldUpdateMapListener, FacesManagerListener {
     ...
     */
    public void addWograldMapListener(@NotNull final MapListener listener) {
     ...
     */
    public void removeWograldMapListener(@NotNull final MapListener listener) {
     ...
     * @param listener the listener to add
     */
    public void addWograldNewmapListener(@NotNull final NewmapListener listener) {
     ...
     * @param listener the listener to remove
     */
    public void removeWograldNewmapListener(@NotNull final NewmapListener listener) {
     ...
     * @param listener the listener to add
     */
    public void addWograldMapScrollListener(@NotNull final MapScrollListener listener) {
     ...
     * @param listener the listener to remove
     */
    public void removeWograldMapScrollListener(@NotNull final MapScrollListener listener) {
