...
public class UnbindCommand extends AbstractCommand {
     ...
     */
    public UnbindCommand(@NotNull final CommandCallback commandCallback, @NotNull final WograldServerConnection wograldServerConnection) {
        super("unbind", wograldServerConnection);
