...
public interface FacesManager {
    ...
    ImageIcon getSpellImageIcon(int faceNum, @Nullable boolean[] isUnknownImage);

       ImageIcon getBlockedImageIcon();
       ImageIcon getDark1ImageIcon();
       ImageIcon getDark2ImageIcon();
       ImageIcon getDark3ImageIcon();
       ImageIcon getFogofwarImageIcon();
    /**
    ...
    Face lookupSpellFace(int faceNum);
