...
public class Filenames {
    ...
    public static File getSettingsFile(@NotNull final String filename) throws IOException {
        final File settingsDir = new File(getWograldFile(), "jxclient");
