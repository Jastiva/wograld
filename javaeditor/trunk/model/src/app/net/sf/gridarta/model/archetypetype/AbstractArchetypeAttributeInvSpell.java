...
public abstract class AbstractArchetypeAttributeInvSpell extends ArchetypeAttribute {
     ...
     */
    protected AbstractArchetypeAttributeInvSpell(@NotNull final String archetypeAttributeName, @NotNull final String attributeName, @NotNull final String description, final int inputLength, @NotNull final String sectionName) {
