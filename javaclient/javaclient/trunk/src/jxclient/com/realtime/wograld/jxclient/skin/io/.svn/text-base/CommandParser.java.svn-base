...
import com.realtime.wograld.jxclient.gui.commands.AccountCreateCharacterCommand;
import com.realtime.wograld.jxclient.gui.commands.AccountCreateCommand;
import com.realtime.wograld.jxclient.gui.commands.AccountLinkCharacterCommand;
import com.realtime.wograld.jxclient.gui.commands.AccountLoginCommand;
import com.realtime.wograld.jxclient.gui.commands.AccountPasswordCommand;
import com.realtime.wograld.jxclient.gui.commands.AccountPlayCharacterCommand;
import com.realtime.wograld.jxclient.gui.commands.CommandCallback;
import com.realtime.wograld.jxclient.gui.commands.CommandType;
import com.realtime.wograld.jxclient.gui.commands.ConnectCommand;
import com.realtime.wograld.jxclient.gui.commands.DialogCloseCommand;
import com.realtime.wograld.jxclient.gui.commands.DialogOpenCommand;
import com.realtime.wograld.jxclient.gui.commands.DialogToggleCommand;
import com.realtime.wograld.jxclient.gui.commands.DisconnectCommand;
import com.realtime.wograld.jxclient.gui.commands.ExecSelectionCommand;
import com.realtime.wograld.jxclient.gui.commands.ExecuteCommandCommand;
import com.realtime.wograld.jxclient.gui.commands.ExecuteElementCommand;
import com.realtime.wograld.jxclient.gui.commands.GUICommand;
import com.realtime.wograld.jxclient.gui.commands.HideCommand;
import com.realtime.wograld.jxclient.gui.commands.MetaCommand;
import com.realtime.wograld.jxclient.gui.commands.MoveSelectionCommand;
import com.realtime.wograld.jxclient.gui.commands.PrintCommand;
import com.realtime.wograld.jxclient.gui.commands.QuitCommand;
import com.realtime.wograld.jxclient.gui.commands.ScrollCommand;
import com.realtime.wograld.jxclient.gui.commands.ScrollListCommand;
import com.realtime.wograld.jxclient.gui.commands.ScrollNeverCommand;
import com.realtime.wograld.jxclient.gui.commands.ScrollNextCommand;
import com.realtime.wograld.jxclient.gui.commands.ScrollResetCommand;
import com.realtime.wograld.jxclient.gui.commands.SelectCommand;
import com.realtime.wograld.jxclient.gui.commands.ShowCommand;
import com.realtime.wograld.jxclient.gui.commands.StartCommand;
import com.realtime.wograld.jxclient.gui.commands.ToggleCommand;
...
import com.realtime.wograld.jxclient.gui.gui.GUISelectable;
import com.realtime.wograld.jxclient.gui.item.GUIItem;
import com.realtime.wograld.jxclient.gui.list.GUIItemList;
import com.realtime.wograld.jxclient.gui.list.GUIList;
...
public class CommandParser {
    ...
    public GUICommand parseCommandArgs(@NotNull final Args args, @Nullable final AbstractGUIElement element, @NotNull final String command, @NotNull final GuiStateManager guiStateManager, @NotNull final Commands commands, @NotNull final LineNumberReader lnr, @NotNull final CommandQueue commandQueue, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final CommandCallback commandCallback, @NotNull final Macros macros) throws IOException, JXCSkinException {
        if (command.equals("SHOW")) {
            ...
            return parseExecSelection(args, element, commandQueue, wograldServerConnection);
     ...
     */
    @NotNull
    private GUICommand parseExecSelection(@NotNull final Args args, @Nullable final GUIElement element, @NotNull final CommandQueue commandQueue, @NotNull final WograldServerConnection wograldServerConnection) throws IOException {
        ...
        return new ExecSelectionCommand((GUIItemList)element, commandType, wograldServerConnection, floorView, commandQueue);
    }
