#!/usr/bin/perl
# $Id: metaserver.pl.in,v 1.2 2010/07/26 22:00:31 jastiv Exp $

# Copyright 2000 by Mark Wedel.
# This script follows the same license as wograld (GPL).
...
while (1) {
	...
	print HTML 
'<title>Wograld Server List</title>
<h1 align=center>Wograld Server List</h1><p>
