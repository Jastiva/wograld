...
public class ScreenshotCommand extends AbstractCommand {
     ...
     */
    public ScreenshotCommand(@NotNull final JXCWindowRenderer windowRenderer, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final ScreenshotFiles screenshotFiles) {
        super("screenshot", wograldServerConnection);
