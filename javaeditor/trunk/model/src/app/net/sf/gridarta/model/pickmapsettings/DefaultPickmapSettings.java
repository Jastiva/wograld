...
/**
 * Default {@link PickmapSettings} implementation. Attributes are retained
...
public class DefaultPickmapSettings extends AbstractPickmapSettings {
    ...
    /**
     * Key for saving {@link #locked} state in preferences.
     */
    @NotNull
     ...
     */
    @Override
    protected void saveLocked(final boolean locked) {
        preferences.putBoolean(LOCKED_KEY, locked);
    }
