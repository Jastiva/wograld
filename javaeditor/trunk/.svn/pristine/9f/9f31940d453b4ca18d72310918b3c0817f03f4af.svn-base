...
public class DialogAttributeMapPath<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> extends DialogAttribute<G, A, R, ArchetypeAttributeMapPath> {
     ...
     */
    public DialogAttributeMapPath(@NotNull final ArchetypeAttributeMapPath ref, @NotNull final TilePanel input) {
        super(ref);
        this.input = input;
    }
