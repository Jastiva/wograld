...
import com.realtime.wograld.jxclient.items.ItemListener;
import com.realtime.wograld.jxclient.items.ItemView;
import com.realtime.wograld.jxclient.items.LocationListener;
...
public class GUIItemInventory extends GUIItemItem {
     ...
     */
    public GUIItemInventory(@NotNull final TooltipManager tooltipManager, @NotNull final GUIElementListener elementListener, @NotNull final CommandQueue commandQueue, final String name, @NotNull final ItemPainter itemPainter, final int index, @NotNull final WograldServerConnection wograldServerConnection, @NotNull final FacesManager facesManager, @NotNull final FloorView floorView, @NotNull final ItemView inventoryView) {
