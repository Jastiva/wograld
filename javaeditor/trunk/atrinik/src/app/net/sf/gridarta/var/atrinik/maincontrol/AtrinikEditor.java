 ...
 */
public class AtrinikEditor {

    /**
     * Prevent instantiation (UtilityClass).
     */
    private AtrinikEditor() {
    }
    ...
    public static void main(final String... args) {
        new GridartaEditor<GameObject, MapArchObject, Archetype>("net.sf.gridarta.var.atrinik.tod").run("net.sf.gridarta.var.atrinik", "AtrinikEditor.jar", new DefaultEditorFactory(), "atrinik.conf", args);
    }
