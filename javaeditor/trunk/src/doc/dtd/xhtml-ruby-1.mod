...
<!-- file: xhtml-ruby-1.mod
     ...
     Revision: $Id: xhtml-ruby-1.mod,v 1.1.1.1 2013/05/29 19:04:31 serpentshard Exp $
...
<!-- Content models of the rb and the rt elements are intended to
     ...
     but it should not include ruby descendant elements. The following
