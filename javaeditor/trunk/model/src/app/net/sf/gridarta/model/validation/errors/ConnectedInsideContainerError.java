 ...
 */
public class ConnectedInsideContainerError<G extends GameObject<G, A, R>, A extends MapArchObject<A>, R extends Archetype<G, A, R>> extends GameObjectValidationError<G, A, R> implements CorrectableError {
     ...
     */
    public ConnectedInsideContainerError(@NotNull final G gameObject) {
        super(gameObject);
    }
