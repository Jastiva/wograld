...
public class TextAreaPainter extends JComponent implements TabExpander {
    ...
    public void paint(@NotNull final Graphics g) {
        tabSize = fontMetrics.charWidth(' ') * 4; // I want 4-space wide tabs
        ...
        // Because the clipRectangle's height is usually an even multiple
        ...
        if (textArea.isCaretVisible()) {
            ...
            if (textArea.isOverwriteEnabled()) {
                ...
                if (caretWidth <= 1) {
                    ...
                    // have zero width. With JDK 1.4.1, such a rectangle with zero width does not get drawn,
