...
package com.realtime.wograld.jxclient.quests;
...
public class QuestsManager {
     ...
     */
    @NotNull
    private final WograldQuestListener wograldQuestListener = new WograldQuestListener() {
     ...
     */
    public QuestsManager(@NotNull final WograldServerConnection wograldServerConnection, @NotNull final GuiStateManager guiStateManager) {
        wograldServerConnection.addWograldQuestListener(wograldQuestListener);
     ...
     */
    public void addWograldQuestChangedListener(@NotNull final QuestsManagerListener listener) {
     ...
     */
    public void removeWograldQuestChangedListener(@NotNull final QuestsManagerListener listener) {
