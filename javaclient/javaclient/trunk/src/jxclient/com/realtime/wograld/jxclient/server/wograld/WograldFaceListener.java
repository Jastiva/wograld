 ...
 */
public interface WograldFaceListener extends EventListener {
     ...
     */
    void faceReceived(int faceNum, int faceSetNum, int faceChecksum, int faceQuad, @NotNull String faceName);
