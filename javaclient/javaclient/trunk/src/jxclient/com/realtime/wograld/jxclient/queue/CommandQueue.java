...
package com.realtime.wograld.jxclient.queue;
...
public class CommandQueue {
     ...
     */
    @NotNull
    private final WograldComcListener wograldComcListener = new WograldComcListener() {
     ...
     * @param wograldServerConnection the server connection for sending ncom
     * commands
     * @param guiStateManager the gui state manager to watch
     */
    public CommandQueue(@NotNull final WograldServerConnection wograldServerConnection, @NotNull final GuiStateManager guiStateManager) {
        this.wograldServerConnection = wograldServerConnection;
        wograldServerConnection.addWograldComcListener(wograldComcListener);
    ...
    public void sendNcom(final boolean mustSend, final int repeat, @NotNull final String command) {
        synchronized (pendingCommands) {
            ...
            final int packetNo = wograldServerConnection.sendNcom(repeat, command);
    ...
    public void sendMove(final int to, final int tag) {
        wograldServerConnection.sendMove(to, tag, getRepeatCount());
    }
